...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skale Visuals" },
      { name: "description", content: "L'agence de création digitale spécialisée en montage vidéo et clipping qui n'ont qu'un seul but : convertir." },
      { property: "og:title", content: "Skale Visuals" },
      { property: "og:description", content: "L'agence de création digitale spécialisée en montage vidéo et clipping qui n'ont qu'un seul but : convertir." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Skale Visuals" },
      { name: "twitter:description", content: "L'agence de création digitale spécialisée en montage vidéo et clipping qui n'ont qu'un seul but : convertir." },
