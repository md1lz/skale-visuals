  ...
  return (
    ...
    >
      <motion.span
        ...
        className="relative inline-block overflow-hidden rounded-xl border-[7px] border-dotted border-primary bg-white px-2.5 py-0.5 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.15)] sm:px-3.5 sm:py-1"
