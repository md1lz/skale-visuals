      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:gap-5">
        {cards.map((card) => (
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black from-0% via-black/95 via-[22%] via-black/70 via-[48%] via-black/35 via-[78%] to-transparent to-[100%]" />
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[65%] bg-gradient-to-t from-black/35 via-black/12 via-[45%] to-transparent to-[100%] backdrop-blur-[2px]" />
