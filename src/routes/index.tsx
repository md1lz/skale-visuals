    ...
    <section className="relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden px-5 pb-12 pt-28 sm:min-h-[65vh] sm:pt-32 lg:pt-36">
      <div className="relative mx-auto max-w-5xl text-center">
        <FadeIn delay={0.1}>
          ...
          <p className="font-codec mx-auto mt-2 max-w-5xl text-balance text-2xl leading-[1.15] tracking-[-0.06em] text-black sm:mt-3 sm:text-3xl lg:text-4xl line-clamp-3 sm:line-clamp-2">
