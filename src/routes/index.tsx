      ...
      <div className="relative mx-auto max-w-5xl text-center">
        <FadeIn delay={0.1}>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <Link
              to="/bookacall"
              className="inline-flex items-center justify-center rounded-full bg-black px-6 py-3 text-sm font-medium uppercase tracking-wide text-white transition hover:scale-[1.03] hover:bg-black/90 active:scale-[0.98]"
            >
              Réserver un appel
            </Link>
            <button
