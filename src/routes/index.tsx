...
function ClientTestimonial({ settings }: { settings: HomeContent["settings"] }) {
  ...
  return (
    <motion.div
      ...
      animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }}
      transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
      className="mx-auto mt-20 flex w-full max-w-5xl flex-col items-center gap-6 px-4 text-left sm:mt-24 sm:flex-row sm:items-center sm:justify-center sm:gap-16"
    >
      <div className="flex shrink-0 items-center gap-3 sm:ml-40 sm:w-48 sm:flex-col sm:items-center sm:justify-center sm:gap-3">
