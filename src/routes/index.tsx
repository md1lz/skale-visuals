  ...
  return (
    ...
    >
      <motion.span
        ...
        className="relative inline-block overflow-hidden rounded-xl border-[5px] border-dashed border-primary bg-white px-3 py-0.5 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.15)] sm:px-4 sm:py-1"
      >
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        <FadeIn delay={0.1}>
          <h1 className="flex flex-col items-center font-codec-bold text-balance text-[2.1rem] leading-[1.1] tracking-[-0.06em] text-foreground sm:text-5xl lg:text-6xl">
            <span className="relative z-10 -mb-[0.38em] block">On optimise le contenu de tes</span>
            <span className="relative z-0 inline-flex items-center gap-2 sm:gap-3">
